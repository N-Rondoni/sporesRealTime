...
if __name__=="__main__":
    ...
    guess = [1, 2, 3, 3, 2, 2]  # Ensure positive values
    ...
    axs[1].plot(timeDat, zDat, 'o', markersize=2, label='Z Data', alpha=0.5)
    axs[1].plot(timeVec, sol_fit.y[1], '-', label='Fitted Z Model', linewidth=2)
    axs[1].axhline(y=zDatMean, color='gray', linestyle='--', linewidth=1, label='Z Data Mean')
